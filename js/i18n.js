...
const I18N = (() => {
    ...
    const DE = {
        ...
        'help.2': 'Eine Vorlage ist eine gespeicherte Abfolge von Phasen. Im Tab <b>Vorlagen</b> kannst du Phasen hinzufügen, umbenennen, umsortieren und ihre Dauer setzen sowie Symbol und Farbe wählen. <b>Pomodoro-Block hinzufügen</b> hängt mehrere Pomodoros mit Pausen auf einmal an. Zieh eine Vorlage an den Punkten links, um die Liste in deine eigene Reihenfolge zu bringen; die Schnellstart-Karten folgen ihr. Mitgelieferte Vorlagen lassen sich bearbeiten oder löschen; <b>Mitgelieferte Vorlagen wiederherstellen</b> oben bringt sie zurück.',
        ...
        'help.4': 'Der große Knopf pausiert und setzt fort. <b>Weiter</b> springt zur nächsten Phase, <b>Zurück</b> startet die aktuelle neu (oder geht zurück, wenn sie gerade erst begonnen hat). <b>+1 / −1 Min</b> verändert die laufende Phase. Wenn eine Phase abläuft und du noch nicht so weit bist, öffnet <b>1 Min mehr</b> oder <b>5 Min mehr</b> diese Phase für die zusätzliche Zeit; die nächste Phase beginnt danach frisch. Das Angebot bleibt, solange der Timer auf dein Tippen wartet, oder zwei Minuten nach einem automatischen Wechsel. Wenn du pausierst und weggehst, meldet sich die App nach zehn Minuten und fragt nach einer Dreiviertelstunde, ob du weitermachen, beenden und behalten oder verwerfen willst. Die Liste unter den Knöpfen zeigt alle Phasen; tippe auf eine, um direkt dorthin zu springen. Der Balken zeigt, wie weit die Sitzung ist und wann sie endet. Den Bildschirm zu verlassen stoppt den Timer nicht; die Karte <b>Weiter</b> im Tab Timer bringt dich zurück.',
        ...
        'help.8': 'Wenn eine Sitzung endet, fragt die Zusammenfassung, <b>wie es gelaufen ist</b>; diese Notiz bleibt bei der Sitzung, und ein Tippen auf eine Sitzung im Verlauf lässt dich sie später schreiben oder ändern. Jede abgeschlossene oder abgebrochene Sitzung landet im <b>Verlauf</b> mit den geschafften Pomodoros und den Fokusminuten. Ein Pomodoro zählt, sobald mindestens 80 % davon vergangen sind. Setze oben ein <b>Tagesziel</b>, dann zeigt der Tab Timer einen Ring, der sich über den Tag füllt, samt deiner Serie an aufeinanderfolgenden Tagen. Der Verlauf zeigt die letzten vier Wochen Tag für Tag und deinen Fokus nach Tageszeit; tippe auf einen Balken für die Zahlen. Alles wird nur auf diesem Gerät gespeichert. <b>Exportieren</b> schreibt Vorlagen, Verlauf und Einstellungen in eine Datei; <b>Importieren</b> liest sie zurück, etwa auf einem neuen Handy.',
        ...
        // ---- Version blocks (HTML) ----
        'ver.1.9.1': '<li>Die deutschen Hilfetexte beschreiben jetzt auch die Notiz zum Abschluss, das Retten einer stehen gebliebenen Sitzung und das Umsortieren der Vorlagen.</li>',
